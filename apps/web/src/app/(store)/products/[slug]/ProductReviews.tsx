          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold border transition-all ${
              showForm
                ...
                : "bento-card text-gray-700 hover:border-sky-300"
            }`}
          >
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              maxLength={100}
              required
              className="w-full h-10 px-3 rounded-xl border border-gray-200 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-sky-200 focus:border-sky-400 transition-shadow"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              maxLength={1000}
              className="w-full px-3 py-2.5 rounded-xl border border-gray-200 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-sky-200 focus:border-sky-400 resize-none transition-shadow"
            />
          ...
          <div className="flex gap-2 pt-1">
            <button
              type="submit"
              disabled={submitting}
              className="px-5 py-2.5 bg-gray-900 text-white text-sm font-bold rounded-xl hover:bg-sky-600 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
            >
