...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description =
    ...
    (slug === "apple"
      ...
      : slug === "anker"
        ? "Buy Anker in Sri Lanka — best prices for Soundcore earbuds, chargers and power banks with live LKR pricing, island-wide delivery, and Kottawa pickup at iCrowd."
        : slug === "ugreen"
          ? "Buy UGREEN in Sri Lanka — best price for power banks and chargers with live LKR pricing, island-wide delivery, and Kandy pickup at iCrowd."
  ...
  return buildPageMetadata({
    title:
      slug === "apple"
        ...
        : slug === "anker"
          ? "Buy Anker Chargers & Power Banks Price in Sri Lanka — iCrowd"
          : slug === "ugreen"
            ? "Buy UGREEN Power Banks & Chargers Price in Sri Lanka — iCrowd"
