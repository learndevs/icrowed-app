      ...
      <div>
        ...
        <div className="flex items-center gap-2 mb-3">
          <input
            ...
            className="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100"
          />
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            >
              ...
              Filters
              {activeCount > 0 && (
                <span className="w-5 h-5 bg-sky-600 text-white text-[10px] font-bold rounded-full flex items-center justify-center">
                  {activeCount}
                </span>
              )}
            </button>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-10 py-3 rounded-2xl border border-gray-200 bg-white text-sm shadow-sm focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100 transition-shadow"
            />
            {search && (
              <button
          ...
          {chips.length > 0 && (
            <div className="flex items-center gap-2 mt-3 flex-wrap">
              ...
              {chips.map((chip) => (
                <span
                  key={chip.label}
                  className="inline-flex items-center gap-1.5 bg-sky-50 text-sky-700 border border-sky-200 text-xs font-semibold px-3 py-1 rounded-full"
                >
                  {chip.label}
                  <button
                    onClick={chip.onRemove}
                    className="w-3.5 h-3.5 rounded-full hover:bg-sky-200 flex items-center justify-center transition-colors"
          ...
          <div className="flex-1 min-w-0">
            ...
            {filtered.length === 0 ? (
              <div className="bento-card p-16 flex flex-col items-center text-center gap-3">
                ...
                <button
                  onClick={clearFilters}
                  className="mt-2 px-5 py-2 bg-gray-900 text-white text-sm font-semibold rounded-full hover:bg-sky-600 transition-colors"
                >
                  Clear filters
                </button>
              </div>
        ...
        <div className="fixed inset-0 z-[200] lg:hidden">
          ...
          <div className="absolute right-0 top-0 h-full w-80 max-w-full bg-white shadow-2xl overflow-y-auto flex flex-col">
            ...
            <div className="sticky bottom-0 bg-white border-t border-gray-100 p-4 flex gap-2">
              ...
              <button
                onClick={() => setDrawerOpen(false)}
                className="flex-1 py-3 bg-gray-900 text-white font-bold rounded-2xl hover:bg-sky-600 transition-colors text-sm"
              >
